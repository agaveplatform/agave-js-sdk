...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AgaveJsSdk.FileMoveAction = factory(root.AgaveJsSdk.ApiClient, root.AgaveJsSdk.FileAction, root.AgaveJsSdk.FileManagementActionType);
  }
  ...
  /**
   * The FileMoveAction model module.
   * @module Model/FileMoveAction
   * @version 0.1.0
   */

  /**
   * Constructs a new <code>FileMoveAction</code>.
   * Request for a file/folder to be moved on the target system. Metadata will be preserved after move.
   * @alias module:Model/FileMoveAction
   * @class
  ...
  /**
   * Constructs a <code>FileMoveAction</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:Model/FileMoveAction} obj Optional instance to populate.
   * @return {module:Model/FileMoveAction} The populated <code>FileMoveAction</code> instance.
   */
