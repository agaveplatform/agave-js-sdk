...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AgaveJsSdk.ApplicationParameterFlagValue = factory(root.AgaveJsSdk.ApiClient, root.AgaveJsSdk.AbstractApplicationParameterValue);
  }
  ...
  /**
   * The ApplicationParameterFlagValue model module.
   * @module Model/ApplicationParameterFlagValue
   * @version 0.1.0
   */

  /**
   * Constructs a new <code>ApplicationParameterFlagValue</code>.
   * An ApplicationParameter representing a flag value
   * @alias module:Model/ApplicationParameterFlagValue
   * @class
  ...
  /**
   * Constructs a <code>ApplicationParameterFlagValue</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:Model/ApplicationParameterFlagValue} obj Optional instance to populate.
   * @return {module:Model/ApplicationParameterFlagValue} The populated <code>ApplicationParameterFlagValue</code> instance.
   */
