...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AgaveJsSdk.PermissionStanza();
  });
  ...
  describe('PermissionStanza', function() {
    it('should create an instance of PermissionStanza', function() {
      // uncomment below and update the code to test PermissionStanza
      //var instance = new AgaveJsSdk.PermissionStanza();
      //expect(instance).to.be.a(AgaveJsSdk.PermissionStanza);
    });
