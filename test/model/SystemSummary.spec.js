...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AgaveJsSdk.SystemSummary();
  });
  ...
  describe('SystemSummary', function() {
    it('should create an instance of SystemSummary', function() {
      // uncomment below and update the code to test SystemSummary
      //var instance = new AgaveJsSdk.SystemSummary();
      //expect(instance).to.be.a(AgaveJsSdk.SystemSummary);
    });
