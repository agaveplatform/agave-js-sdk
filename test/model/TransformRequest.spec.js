...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AgaveJsSdk.TransformRequest();
  });
  ...
  describe('TransformRequest', function() {
    it('should create an instance of TransformRequest', function() {
      ...
      //var instance = new AgaveJsSdk.TransformRequest();
      //expect(instance).to.be.a(AgaveJsSdk.TransformRequest);
    });

    it('should have the property nativeFormat (base name: "nativeFormat")', function() {
      // uncomment below and update the code to test the property nativeFormat
      //var instance = new AgaveJsSdk.TransformRequest();
